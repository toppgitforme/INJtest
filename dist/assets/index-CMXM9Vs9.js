...
import{ac as A,ad as M,d as k,r as $,a as L,i as y,U as u,b as x,w as s,v as f,ae as Z,c as O}from"./wallet-other-DeBqkjrb.js";import{b5 as i}from"./injective-sdk-yGcRIHv8.js";const T={attribute:!0,type:String,converter:M,reflect:!1,hasChanged:A},I=(t=T,e,o)=>{const{kind:r,metadata:n}=o;let l=globalThis.litPropertyMetadata.get(n);if(l===void 0&&globalThis.litPropertyMetadata.set(n,l=new Map),r==="setter"&&((t=Object.create(t)).wrapped=!0),l.set(o.name,t),r==="accessor"){const{name:a}=o;return{set(h){const v=e.get.call(this);e.set.call(this,h),this.requestUpdate(a,v,t,!0,h)},init(h){return h!==void 0&&this.C(a,void 0,t,h),h}}}if(r==="setter"){const{name:a}=o;return function(h){const v=this[a];e.call(this,h),this.requestUpdate(a,v,t,!0,h)}}throw Error("Unsupported decorator location: "+r)};function p(t){return(e,o)=>typeof o=="object"?I(t,e,o):((r,n,l)=>{const a=n.hasOwnProperty(l);return n.constructor.createProperty(l,r),a?Object.getOwnPropertyDescriptor(n,l):void 0})(t,e,o)}function x1(t){return p({...t,state:!0,attribute:!1})}const R=k`
  :host {
    display: flex;
    width: inherit;
    height: inherit;
...
`;var g=function(t,e,o,r){var n=arguments.length,l=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(t,e,o,r);else for(var h=t.length-1;h>=0;h--)(a=t[h])&&(l=(n<3?a(l):n>3?a(e,o,l):a(e,o))||l);return n>3&&l&&Object.defineProperty(e,o,l),l};let c=class extends y{render(){return this.style.cssText=`
      ...
      width: ${this.width};
    `,x`<slot></slot>`}};c.styles=[$,R];g([p()],c.prototype,"flexDirection",void 0);g([p()],c.prototype,"flexWrap",void 0);g([p()],c.prototype,"flexBasis",void 0);g([p()],c.prototype,"flexGrow",void 0);g([p()],c.prototype,"flexShrink",void 0);g([p()],c.prototype,"alignItems",void 0);g([p()],c.prototype,"justifyContent",void 0);g([p()],c.prototype,"columnGap",void 0);g([p()],c.prototype,"rowGap",void 0);g([p()],c.prototype,"gap",void 0);g([p()],c.prototype,"padding",void 0);g([p()],c.prototype,"margin",void 0);g([p()],c.prototype,"width",void 0);c=g([L("wui-flex")],c);const b=Symbol.for(""),D=t=>{if(t?.r===b)return t?._$litStatic$},z=t=>({_$litStatic$:t,r:b}),H=new Map,B=t=>(e,...o)=>{const r=o.length;let n,l;const a=[],h=[];let v,d=0,E=!1;for(;d<r;){for(v=e[d];d<r&&(l=o[d],(n=D(l))!==void 0);)v+=n+e[++d],E=!0;d!==r&&h.push(l),a.push(v),d++}if(d===r&&a.push(e[r]),E){const P=a.join("$$lit$$");(e=H.get(P))===void 0&&(a.raw=a,H.set(P,e=a)),o=h}return t(e,...o)},S=B(x),j=s`<svg width="30" height="30" viewBox="0 0 30 30" fill="none">
...
</svg>`,U=s`<svg fill="none" viewBox="0 0 40 40">
  <g clip-path="url(#a)">
    <g clip-path="url(#b)">
...
`,F=s`<svg width="30" height="30" viewBox="0 0 30 30" fill="none">
...
>
...
</svg>`,X=s`<svg fill="none" viewBox="0 0 16 16">
  <path
    fill="currentColor"
...
</svg>`,J=s`<svg style="border-radius: 9999px; overflow: hidden;"  fill="none" viewBox="0 0 1000 1000">
  ...
  />
</svg>`,t1=s` <svg width="27" height="30" viewBox="0 0 27 30" fill="none">
...
</svg>`,e1=s`<svg width="75" height="20" viewBox="0 0 75 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,r1=s`<svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <g clip-path="url(#a)">
...
`,l1=s`<svg fill="none" viewBox="0 0 40 40">
  <g clip-path="url(#a)">
    <g clip-path="url(#b)">
...
</svg>`,n1=s`<svg fill="none" viewBox="0 0 16 16">
  <path
    fill="currentColor"
...
`;var w=function(t,e,o,r){var n=arguments.length,l=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(t,e,o,r);else for(var h=t.length-1;h>=0;h--)(a=t[h])&&(l=(n<3?a(l):n>3?a(e,o,l):a(e,o))||l);return n>3&&l&&Object.defineProperty(e,o,l),l};const $1={primary:f.tokens.theme.textPrimary,secondary:f.tokens.theme.textSecondary,tertiary:f.tokens.theme.textTertiary,invert:f.tokens.theme.textInvert,error:f.tokens.core.textError,warning:f.tokens.core.textWarning,"accent-primary":f.tokens.core.textAccentPrimary};let m=class extends y{constructor(){super(...arguments),this.variant="md-regular",this.color="inherit",this.align="left",this.lineClamp=void 0,this.display="inline-flex"}render(){const e={[`wui-font-${this.variant}`]:!0,[`wui-line-clamp-${this.lineClamp}`]:!!this.lineClamp};return this.style.cssText=`
      display: ${this.display};
      --local-align: ${this.align};
      --local-color: ${this.color==="inherit"?"inherit":$1[this.color??"primary"]};
      `,x`<slot class=${w1(e)}></slot>`}};m.styles=[$,C1];w([p()],m.prototype,"variant",void 0);w([p()],m.prototype,"color",void 0);w([p()],m.prototype,"align",void 0);w([p()],m.prototype,"lineClamp",void 0);w([p()],m.prototype,"display",void 0);m=w([L("wui-text")],m);export{o1 as a,w1 as b,v1 as e,_1 as i,p as n,x1 as r,m1 as t};
