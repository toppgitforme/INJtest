...
`;var k=function(n,e,a,s){var r=arguments.length,o=r<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,a):s,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,a,s);else for(var p=n.length-1;p>=0;p--)(u=n[p])&&(o=(r<3?u(o):r>3?u(e,a,o):u(e,a))||o);return r>3&&o&&Object.defineProperty(e,a,o),o};const me=4e3;let N=class extends F{constructor(){super(),this.loadingMessage="",this.subMessage="",this.paymentState="in-progress",this.paymentState=l.state.isPaymentInProgress?"in-progress":"completed",this.updateMessages(),this.setupSubscription(),this.setupExchangeSubscription()}disconnectedCallback(){clearInterval(this.exchangeSubscription)}render(){return m`
    ...
    `}getPaymentIcon(){const e=l.state.currentPayment;if(e){if(e.type==="exchange"){const a=e.exchangeId;if(a)return l.getExchangeById(a)?.imageUrl}if(e.type==="wallet"){const a=d.getAccountData()?.connectedWalletInfo?.icon;if(a)return a;const s=d.state.activeChain;if(!s)return;const r=M.getConnectorId(s);if(!r)return;const o=M.getConnectorById(r);return o?Z.getConnectorImage(o):void 0}}}successTemplate(){return m`<wui-icon size="xl" color="success" name="checkmark"></wui-icon>`}errorTemplate(){return m`<wui-icon size="xl" color="error" name="close"></wui-icon>`}};N.styles=pe;k([h()],N.prototype,"loadingMessage",void 0);k([h()],N.prototype,"subMessage",void 0);k([h()],N.prototype,"paymentState",void 0);N=k([H("w3m-pay-loading-view")],N);const ye=3e5;async function he(n){return l.handleOpenPay(n)}async function Ye(n,e=ye){if(e<=0)throw new c(i.INVALID_PAYMENT_CONFIG,"Timeout must be greater than 0");try{await he(n)}catch(a){throw a instanceof c?a:new c(i.UNABLE_TO_INITIATE_PAYMENT,a.message)}return new Promise((a,s)=>{let r=!1;const o=setTimeout(()=>{r||(r=!0,S(),s(new c(i.GENERIC_PAYMENT_ERROR,"Payment timeout")))},e);function u(){if(r)return;const T=l.state.currentPayment,U=l.state.error,K=l.state.isPaymentInProgress;if(T?.status==="SUCCESS"){r=!0,S(),clearTimeout(o),a({success:!0,result:T.result});return}if(T?.status==="FAILED"){r=!0,S(),clearTimeout(o),a({success:!1,error:U||"Payment failed"});return}U&&!K&&!T&&(r=!0,S(),clearTimeout(o),a({success:!1,error:U}))}const p=D("currentPayment",u),g=D("error",u),I=D("isPaymentInProgress",u),S=we([p,g,I]);u()})}function Ge(){return l.getExchanges()}function Ve(){return l.state.currentPayment?.result}function $e(){return l.state.error}function Be(){return l.state.isPaymentInProgress}function D(n,e){return l.subscribeKey(n,e)}function we(n){return()=>{n.forEach(e=>{try{e()}catch{}})}}const We={network:"eip155:8453",asset:"native",metadata:{name:"Ethereum",symbol:"ETH",decimals:18}},Fe={network:"eip155:8453",asset:"0x833589fcd6edb6e08f4c7c32d4f71b54bda02913",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},He={network:"eip155:84532",asset:"native",metadata:{name:"Ethereum",symbol:"ETH",decimals:18}},Ke={network:"eip155:1",asset:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},je={network:"eip155:10",asset:"0x0b2c639c533813f4aa9d7837caf62653d097ff85",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},qe={network:"eip155:42161",asset:"0xaf88d065e77c8cC2239327C5EDb3A432268e5831",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},ze={network:"eip155:137",asset:"0x3c499c542cef5e3811e1192ce70d8cc03d5c3359",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},Xe={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},Je={network:"eip155:1",asset:"0xdAC17F958D2ee523a2206206994597C13D831ec7",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Ze={network:"eip155:10",asset:"0x94b008aA00579c1307B0EF2c499aD98a8ce58e58",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Qe={network:"eip155:42161",asset:"0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},et={network:"eip155:137",asset:"0xc2132d05d31c914a87c6611c10748aeb04b58e8f",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},tt={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},nt={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"native",metadata:{name:"Solana",symbol:"SOL",decimals:9}};export{N as W3mPayLoadingView,y as W3mPayView,qe as arbitrumUSDC,Qe as arbitrumUSDT,We as baseETH,He as baseSepoliaETH,Fe as baseUSDC,Ke as ethereumUSDC,Je as ethereumUSDT,Ge as getExchanges,Be as getIsPaymentInProgress,$e as getPayError,Ve as getPayResult,he as openPay,je as optimismUSDC,Ze as optimismUSDT,Ye as pay,ze as polygonUSDC,et as polygonUSDT,nt as solanaSOL,Xe as solanaUSDC,tt as solanaUSDT};
