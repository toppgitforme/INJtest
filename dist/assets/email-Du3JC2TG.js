import{f as S,s as g,O as h,E as c,M as _,R as s,S as f,k as C,a as d,c as D,i as b,m,b as u,d as $,x as W,C as P}from"./wallet-other-DeBqkjrb.js";import{W as y}from"./index-CKcE2-MQ.js";import{r as E}from"./index-CMXM9Vs9.js";import"./index-B8FWWaSE.js";import"./index-D5wH_mwz.js";import{e as N,n as T}from"./ref-dsQEHo0r.js";import"./index-CGnD9YQJ.js";import"./index-BgZyw5vj.js";import"./injective-utils-C9MYzl-J.js";import"./icons-Dj0zHVqu.js";import"./injective-sdk-yGcRIHv8.js";import"./wallet-core-CdETWVBX.js";import"./injective-networks-BywkriB7.js";import"./index-C_iDTYjL.js";import"./if-defined-pKzrT_vf.js";import"./index-DN0i5kja.js";var F=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends y{constructor(){super(...arguments),this.onOtpSubmit=async e=>{try{if(this.authConnector){const t=S.state.activeChain,r=g.getConnections(t),n=h.state.remoteFeatures?.multiWallet,i=r.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),t)await g.connectExternal(this.authConnector,t);else throw new Error("Active chain is not set on ChainController");if(h.state.remoteFeatures?.emailCapture)return;if(h.state.siwx){_.close();return}if(i&&n){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(t){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(t)}}),t}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([d("w3m-email-verify-otp-view")],I);const U=D`
  wui-icon-box {
